...
- Car, Bike are child classes of Vehicle class.
- But Garage is neither a parent nor a child class.
- The Garage class has two arrays as instance variables 
  called cars and bikes that can store Car and Bike objects.
- In this task you’ll need to use the instanceof keyword and downcasting.
